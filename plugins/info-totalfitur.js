let mufar = async (m, { conn }) => {
  ...
  conn.sendMessage(m.chat, { text: `*[ FRACTION LIST ]*\n\n ${tagList}\n\n*Total fitur:${totalfi} Commands*`, contextInfo: { externalAdReply: { title: wm, body: bottime, mediaType: 1, thumbnailUrl: 'https://telegra.ph/file/4201cff9947c81934cf5d.jpg', sourceUrl: 'https://Javanese', renderLargerThumbnail: true } } }, { quoted: m, ephemeralExpiration: global.ephemeral })
}
