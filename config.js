...
//TIME
global.waktu = `${date}`
global.namabot = 'itscukki botz'
global.v = '-'   
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ TIME: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
// Sticker WM
global.packname = `☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴢᴀʟᴀʟɪᴀ ᴍᴜʟᴛɪ ᴅᴇᴠɪᴄᴇ`
...
//--------[WATERMARK]
global.wm = 'itscukki botz' //Main WM
...
global.footer = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ ฅ˘itscukki botz˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
/*============== SOCIAL ==============*/
global.sig = 'https://instagram.com/zalaliaa' //Link Instagrammu
global.sgh = 'https://github.com/' //Link Githubmu
global.sgc = 'https://chat.whatsapp.com/IQTsBoeeVw5GML5ewy86Rf'
global.sdc = '-' //Isi Pake Link Discordmu Kalo Gada Biarin aja
global.snh = 'https://nhentai.net/g/HaramTod🗿' //Hmmm, Ini boleh kalian isi terserah :v
//global.logo = ImgMountain()
global.sfb = 'https://www.facebook.com/'
global.syt = 'https://youtube.com/@itscukki.'
